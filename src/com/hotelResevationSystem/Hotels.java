...
public class Hotels {
	...
	public String toString() {
		return ("Hotel Name: "+this.getHotelName()+
	            " Hotel Rating: " + this.getHotelRating()+
				" Regular: Hotel Rate weekday: "+ this.getHotelRateRegularWeekDay() +
	            " Regular: Hotel Rate weekend: "+ this.getHotelRateRegularWeekEnd() +
	            " Reward: Hotel Rate weekday: " + this.getHotelRateRewardWeekDay() + 
	            " Reward: Hotel Rate weekend: " + this.getHotelRateRewardWeekEnd());
	}
}
