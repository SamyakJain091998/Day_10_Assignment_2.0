	...
	public void editDetailsOfHotel(String nameOfHotel) {
		...
		while(itr.hasNext()) {
			...
			if(nameOfHotel.equals(dummyH.getHotelName())) {
				System.out.println("Enter updated value of rating of "
						+ "Hotel " + nameOfHotel + " :");
				int hotelRating = sc.nextInt();
				dummyH.setHotelRating(hotelRating);
				
				System.out.println("Enter updated value of weekday rate for regular customer of "
						+ "Hotel " + nameOfHotel + " :");
				int hotelRateRegularWeekDay = sc.nextInt();
				dummyH.setHotelRateRegularWeekDay(hotelRateRegularWeekDay);

				System.out.println("Enter updated value of weekend rate for regular customer of "
						+ "Hotel " + nameOfHotel + " :");
				int hotelRateRegularWeekEnd = sc.nextInt();
				dummyH.setHotelRateRegularWeekEnd(hotelRateRegularWeekEnd);
				
				System.out.println("Enter updated value of weekday rate for reward customer of "
						+ "Hotel " + nameOfHotel + " :");
				int hotelRateRewardWeekDay = sc.nextInt();
				dummyH.setHotelRateRewardWeekDay(hotelRateRewardWeekDay);
				
				System.out.println("Enter updated value of weekend rate for reward customer of "
						+ "Hotel " + nameOfHotel + " :");
